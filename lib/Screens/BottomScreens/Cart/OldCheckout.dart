              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            //     children: [
                                            //       InkWell(
                                            //           onTap: widget.cartProducts[index].loadinglike == true
                                            //               ? (){}
                                            //               : (){
                                            //             widget.cartProducts[index].quantity! <= 1
                                            //                 ? context.read<CartProductsBloc>().add(DeleteCartEvent(state.cartProductsModel.viewCart![index]))
                                            ...
                                            //       )
                                            //           : Text(widget.cartProducts[index].quantity.toString(), style: const TextStyle(color: Colors.white,
                    ...
                    // BlocBuilder<CartProductsBloc, CartProductsState>(builder: (context, state) {
                    //
                    ...
                    //   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    //   children: [
                    //     Text('Delivery Address', style: TextStyles.font18w7(Colors.black),),
                    ...
                    //     expandIcon: Icons.arrow_forward_ios,  // Icon when collapsed
                    //     collapseIcon: Icons.keyboard_arrow_down_sharp,  // Icon when expanded
                    //     iconColor: Colors.black,
                    //     iconSize: 15.0,
                    //     useInkWell: false,
                    //
                    //   ),
                    //   header: Text('Delivery Address', style: TextStyles.font18w7(Colors.black),),
                    ...
                    //             Row(
                    //               children: [
                    //                 Image.asset('assets/images/del_addr.png', height: 50, width: 50,),
                    //                 SizedBox(width: 10,),
                    //                 SizedBox(
                    //                     width: MediaQuery.of(context).size.width*.65,
                    //                     // child: Text('3 Newbridge Court Chino Hills, CA 91709, United States', style: TextStyles.font15w4(Colors.black)))
                    //                     child: Text('${widget.address![index].address}, ${widget.address![index].city}, ${widget.address![index].state}, ${widget.address![index].zipCode}, ${widget.address![index].country}', style: TextStyles.font15w4(Colors.black)))
                    //               ],
                    //             ),
                    //             SizedBox(
                    //               height: 24,
                    //               width: 24,
                    //               child: Radio(value: 'add${index}',
                    //                 groupValue: 'Add$index', onChanged: (value) {
                    //
                    //               },),
                    //             )
                    //             // Image.asset('assets/images/Check.png', height: 25, width: 25,)
                    //           ],
                    //         ),
                    //       );
                    //     },)
                    //   /*Text(article.body, softWrap: true, maxLines: 2, overflow: TextOverflow.ellipsis,)*/,
                    //   expanded: ListView.builder(
                    //     physics: NeverScrollableScrollPhysics(),
                    ...
                    //               height: 24,
                    //               width: 24,
                    //               child: Radio(value: 'false', groupValue: 'Add$index', onChanged: (value) {
                    //
                    //               },),
                    //             )
                    //             // Image.asset('assets/images/Check.png', height: 25, width: 25,)
                    ...
                    //         dashPattern: [5, 3], // Pattern of the dash
                    //         borderType: BorderType.RRect,
                    //         radius: Radius.circular(8), // Rounded corners
                    //         child: Container(
                    //           padding: EdgeInsets.symmetric(horizontal: 10), // Inner padding
                    //           color: Color(0xFFFFFBF5), // Background color inside the border
                    //           child: TextField(
                    ...
                    //     ElevatedButton(
                    //       onPressed: () {
                    //         // Define the logic for applying the coupon here
                    //       },
                    //       style: ElevatedButton.styleFrom(
                    //         surfaceTintColor: Colors.orange, // Background color of the button
                          ...
                          child: Center(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  suffixIcon: BlocListener<GetCouponModelBloc, GetCouponModelState>(
                                    listener: (context, state) {
                                      if (state is GetCouponModelSuccess) {
                                        FocusScope.of(context).unfocus();
                                        // If the couponCode is not empty, it means the coupon was applied successfully
                                        if (context.read<GetCouponModelBloc>().couponCode.isNotEmpty) {
                                          final message = context.read<GetCouponModelBloc>().message;
                                          final totalAmount1 = context.read<GetCouponModelBloc>().totalAmount;
                                          discount = context.read<GetCouponModelBloc>().discount;
                                          final coupon = context.read<GetCouponModelBloc>().couponCode;
                                          ...
                                          if(state.getCouponModel.status != false){
                                            print('status :::: ${state.getCouponModel.status}');
                                    ...
                                    child: TextButton(
                                        onPressed:  () {
                                          ...
                                          if (couponController.text.isNotEmpty) {
                                            ...
                                            context.read<GetCouponModelBloc>().add(
                                              ApplyCouponEvent(
                                                context,
                                                cartIds,
                    ...
                    //               SizedBox(width: 10,),
                    //               Text('Credit/Debit Card', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),)
                    //             ],
                    //           ),
                    //           Radio(
                    //             value: 'Credit',
                    ...
                    BlocListener<PlaceOrderBloc, PlaceOrderState>(
                      ...
                      child: Btn('', height: 50, width: MediaQuery.of(context).size.width,
                          ...
                          name: 'Proceed To Order', callBack: (){
                            ...
                            //     totalPrice.toString(), discount.toString(), totalAmount,
                            //     'cod', delivery_Opt, selectedAddressId.toString(), couponController.text, messageController.text));
                            // showOrderDialog();
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => AddShippingAddress()));
                          }),
                    ),
                    const SizedBox(height: 10,),
                    // Btn2(height: 50, width: MediaQuery.of(context).size.width, name: 'Delivery', callBack: () {
                    //   showOrderDialog();
                    // },)
                  ],
                ),
                                            ...
                                            child: Center(
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    //     children: [
                                                    //       Text('%', style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400, fontSize: 14)),
                                                    //       Text('off', style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400, fontSize: 14),),
                                                    //     ],
                                                    //   ),
                                                    // )
                                                  ],
                                          ...
                                          child: Column(
                                            children: [
                                              Text('${state.getCouponModel.availableCoupon![index].expire ?? 0} day after'/*promoCodes[index]['time']*/, style: const TextStyle(
                                                  ...
                                                  fontSize: 14)),
                                              BlocListener<GetCouponModelBloc, GetCouponModelState>(
                                                listener: (context, state) {
                                                  if (state is GetCouponModelSuccess) {
                                                    // If the couponCode is not empty, it means the coupon was applied successfully
                                                    if (context.read<GetCouponModelBloc>().couponCode.isNotEmpty) {
                                              ...
                                              //         // });
                                              //
                                              //         // Show the message or handle success case
                                              //         Fluttertoast.showToast(msg: message, backgroundColor: Constant.bgOrangeLite);
                                              //         // ScaffoldMessenger.of(context).showSnackBar(
                                              //         //     SnackBar(content: Text('Coupon Applied: $message\nTotal: $totalAmount\nDiscount: $discount'))
                                              //         // );
                                              //       }else{
                                              //
                                              //         final message = context.read<GetCouponModelBloc>().message;
                                              ...
                                              //   child: InkWell(
                                              //     onTap: (){
                                              //       context.read<GetCouponModelBloc>().add(ApplyCouponEvent(cartIds,
                                              //           state.getCouponModel.availableCoupon![index].code.toString(), totalPrice.toString()));
                                              //     },
                                              //     child: Container(
                                              //       width: 100,
                                              //       height: 35,
